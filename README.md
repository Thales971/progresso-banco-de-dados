...
## Modernizacao do sistema da gameflix

Contexto:
O gameflix é uma plataforma de streming de jogos que virou febre entre os jovens.Com o sucesso, eles precisarem atualizar constantemente seu banco de dados.
